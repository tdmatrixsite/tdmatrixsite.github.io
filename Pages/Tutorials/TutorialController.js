var tutorialController=function($scope,$window)
{
  $scope.classLinkClicked=function(className)
  {

      $('html, body').stop().animate({scrollTop:$("#"+className).offset().top});
  };
    ...
    },
    {
      ...
      [
        ...
        },
        {
          ...
          parameters:[{link:"Document",type:'Document',value:'sourceDoc'},{link:"Document",type:'Document',value:'destDoc'}],
        ...
        },
        {
          ...
          parameters:[{link:"Document",href:"Document",type:'Document[]',value:'quotes'},{type:'int',value:'minthrshold'}],
        ...
        },
        {
          ...
          parameters:[{link:"Document",href:"Document",type:'Document[]',value:'documents'},{type:'int',value:'minTermWeight'}],
          returnType:{type:"Boolean"},
